...
from reverse_dfs import (
    ...
    reverse_transition_matrix_core,
...
def transition_matrix():
    ...
    return [
        ...
        [None, [(3/4, 3), (1/4, 4)], [(1/2, 5), (1/2, 6)], None, [(1, 4)],
         [(1, 5)], [(1, 6)]],
    ]
...
def test_reverse_transition_matrix(transition_matrix):
    ...
    expected_reversed_transitions = {
        1: [0], 2: [0], 4: [3, 1, 4], 5: [3, 2, 5], 3: [1], 6: [2, 6], 0: []}
...
def test_reverse_dfs_state_two_can_not_reach(
        transition_matrix_state_two_can_not_reach_state_five, final_states):
